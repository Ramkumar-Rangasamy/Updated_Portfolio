  ...
  return (
    <section id="home" className="home-banner-01 d-flex align-items-center justify-content-center">
      <div className="container-lg">
        {/* Status Section */}
        <div className="home-availability-container text-center text-lg-start">
        ...
        <div className="row align-items-center gy-4 my-2">
          ...
          <div className="col-lg-7 order-2 order-lg-1 mobileview-style">
            ...
            <h4 className="hs-role mb-4 mb-lg-5">
            ...
            {/* CTA Buttons */}
            <div className="d-flex align-items-center gap-3 flex-wrap mobile-tyle-btn-btns">
